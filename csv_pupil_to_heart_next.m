function csv_pupil_to_heart_next(heart_start,heart_end,file1,output_file)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
for i=1:1:l1
 if(heart_start -0.1  < b(i,1) && heart_start + 0.1 > b(i,1))
    eye_start = b(i,1); 
    start_index = i;
end
end
...
for i=1:1:l1
 if(heart_end -0.1 < b(i,1) && heart_end + 0.1 > b(i,1))
     eye_end = b(i,1);
     end_index= i;
 end
end
